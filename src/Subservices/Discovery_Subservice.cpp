...
int DiscoverySubservice::server() {
    int sockfd;
...
int DiscoverySubservice::client() {
    int sockfd;
    ...
    while (true) {
        if (!DiscoverySubservice::isDiscovered) { // Check if the computer has not been discovered yet
...
string DiscoverySubservice::getIPAddress() {
    Utils::getIPAddress();
}

string DiscoverySubservice::getMacAddress() {
    Utils::getMacAddress();
}

string DiscoverySubservice::getManagerIp(const vector<Computer>& computers) {
    Utils::getManagerIp(computers);
}

int DiscoverySubservice::createSocket() {
    Utils::createSocket();
}

void DiscoverySubservice::setSocketTimeout(int sockfd, int sec) {
    Utils::setSocketTimeout(sockfd, sec);
}

struct DiscoverySubservice::sockaddr_in configureServerAddress(const string& ip, int ports) {
